...
| `FILE_TRANSFER_SERVICE_URL`                     | `https://<AWS_URL>/strike-off-objections/files`       | Allows upload of user documents.                                                          |
| `CHS_INTERNAL_API_KEY`                          | <API_KEY>                                             | Secures access to the file transfer service.                                              |
