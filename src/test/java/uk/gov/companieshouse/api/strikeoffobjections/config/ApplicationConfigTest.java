...
class ApplicationConfigTest {
    ...
    private final static String CHIPS_KAFKA_CONFIG_MESSAGE = "CHS ENV CONFIG - FEATURE_FLAG_USE_KAFKA_FOR_CHIPS_CALL_170121 = %s";
    ...
    void testGetChipsSenderReturnsChipsKafkaClient() {
        ChipsSender chipsSender = applicationConfig.getChipsSender(
                chipsKafkaClient,
                chipsRestClient,
                true,
                apiLogger);
