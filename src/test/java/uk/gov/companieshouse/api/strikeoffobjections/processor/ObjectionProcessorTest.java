...
import static uk.gov.companieshouse.api.strikeoffobjections.common.LogConstants.COMPANY_NUMBER;
...
class ObjectionProcessorTest {
    ...
    void processTest() throws Exception {
        ...
        Objection dummyObjection = Utils.getTestObjection(OBJECTION_ID, REASON, COMPANY_NUMBER, USER_ID, EMAIL);
