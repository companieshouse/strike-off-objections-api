...
class ObjectionControllerTest {
    ...
    void createObjectionTest() throws Exception {
        ...
        ResponseEntity<ChResponseBody<ObjectionResponse>> response = objectionController.
                createObjection(COMPANY_NUMBER, REQUEST_ID, AUTH_ID, AUTH_USER);
    ...
    void createObjectionExceptionTest() throws Exception {
        ...
        ResponseEntity<ChResponseBody<ObjectionResponse>> response = objectionController.createObjection(
                COMPANY_NUMBER, REQUEST_ID, AUTH_ID, AUTH_USER);
